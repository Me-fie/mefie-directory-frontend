...
export function FileUploader({ label, multiple = false, files, onChange, emptyText = "No files uploaded yet" }: FileUploaderProps) {
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs">
              <p>Use images to engage people who are interested in your {multiple ? "listing" : "listing"}</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
